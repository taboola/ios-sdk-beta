...
/*!
 @brief This methoode refresh the recommendations list.
*/
- (void)updateContentOnly;

/*!
 @brief This method resolves the discrepancy between fetchContent() methods in iOS and Android
 Calling this method will always fetch content. Subsequent calls to fetchContent() will only update the existing content.
*/
- (void)fetchContentOnly;


/// Refresh content
- (void)refresh __deprecated_msg("The method is deprecated. Please use fetchContent for refreshing");
/*
...
/*!
 @brief Adds to parameters an ActionType and relevant data
